...
## [Prueba antes de la lección ](https://white-water-09ec41f0f.azurestaticapps.net/quiz/11/)

> ### [Ésta lección está disponible en R!](./solution/R/lesson_2-R.ipynb)

## Introducción

Ahora que estas preparado con las herramientas para construir modelos de aprendizaje automático (AA) con Scikit-learn, estas listo para empezar a hacer preguntas a sus datos. Mientras trabajas con los datos y aplicas soluciones de AA, es muy importante a entender CÓMO hacer la pregunta correcta para descubrir la potencial de tu conjunto de datos

En esta lección, aprenderás:

- Cómo preparar tus datos para construir modelos.
- Cómo utilizar Matplotlib para la visualización de datos.
...
> 🎥 Hace Click en la imagen arriba para un video sobre aspectos de ésta lección
